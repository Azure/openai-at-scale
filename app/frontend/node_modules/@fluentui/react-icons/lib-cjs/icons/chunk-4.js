...
const LockClosedKeyFilledIcon = props => {
  const {
    fill: primaryFill = 'currentColor',
    className
  } = props;
...
exports.LockClosedKeyFilled = wrapIcon_1.default( /*#__PURE__*/LockClosedKeyFilledIcon, 'LockClosedKeyFilled');
const LockClosedKeyRegularIcon = props => {
  const {
    fill: primaryFill = 'currentColor',
    className
  } = props;
...
exports.LockClosedKeyRegular = wrapIcon_1.default( /*#__PURE__*/LockClosedKeyRegularIcon, 'LockClosedKeyRegular');
...
const MountainLocationBottomFilledIcon = props => {
  const {
    fill: primaryFill = 'currentColor',
    className
  } = props;
  return React.createElement("svg", Object.assign({}, props, {
    ...
    d: "M8.19 2.78a2.5 2.5 0 0 1 3.62 0l5.37 5.65A3 3 0 0 1 18 10.5V15a2 2 0 0 1-2 2h-4.32c.27-.4.56-.85.8-1.3.24-.47.52-1.1.52-1.7a3 3 0 1 0-6 0c0 .6.28 1.23.53 1.7.23.45.52.9.79 1.3H4a2 2 0 0 1-2-2v-4.5a3 3 0 0 1 .82-2.07L8.2 2.78Zm2.9.7a1.5 1.5 0 0 0-2.18 0l-3.23 3.4c.77.5 1.4.7 1.96.74.66.04 1.26-.13 1.92-.4l.7-.3c.9-.4 1.93-.88 3.2-.95l-2.37-2.5Zm-2.7 11.7c.25.49.57 1 .87 1.42a.9.9 0 0 0 1.48 0c.3-.42.62-.93.87-1.41.23-.45.39-.88.39-1.19a2 2 0 1 0-4 0c0 .31.16.74.4 1.19Zm2.37-.53a1 1 0 1 1-1.52-1.3 1 1 0 0 1 1.52 1.3Z",
    fill: primaryFill
  }));
};
exports.MountainLocationBottomFilled = wrapIcon_1.default( /*#__PURE__*/MountainLocationBottomFilledIcon, 'MountainLocationBottomFilled');
const MountainLocationBottomRegularIcon = props => {
  const {
    fill: primaryFill = 'currentColor',
    className
  } = props;
...
exports.MountainLocationTopRegular = wrapIcon_1.default( /*#__PURE__*/MountainLocationTopRegularIcon, 'MountainLocationTopRegular');
const MountainTrailFilledIcon = props => {
  const {
    fill: primaryFill = 'currentColor',
    className
  } = props;
...
exports.MountainTrailFilled = wrapIcon_1.default( /*#__PURE__*/MountainTrailFilledIcon, 'MountainTrailFilled');
const MountainTrailRegularIcon = props => {
  const {
    fill: primaryFill = 'currentColor',
    className
  } = props;
