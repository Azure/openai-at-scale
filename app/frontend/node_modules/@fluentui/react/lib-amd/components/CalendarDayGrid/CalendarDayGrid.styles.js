        ...
        return {
            ...
            dayCell: [
                style_utilities_1.getFocusStyle(theme, { inset: -3 }),
                {
                    ...
                    position: 'relative',
                    selectors: (_a = {},
                        _a[style_utilities_1.HighContrastSelector] = tslib_1.__assign({ color: 'WindowText', backgroundColor: 'transparent', zIndex: 0 }, style_utilities_1.getHighContrastNoAdjustStyle()),
